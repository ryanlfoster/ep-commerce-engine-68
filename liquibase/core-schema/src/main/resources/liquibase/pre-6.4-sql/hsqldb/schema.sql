...
(
    ...
    RULE_CODE VARCHAR(4096) NOT NULL,
    PRIMARY KEY(UIDPK));
...
(
    ...
    SCENARIO INTEGER NOT NULL,
    LAST_MODIFIED_DATE TIMESTAMP default CURRENT_TIMESTAMP NOT NULL,
    RULEBASE LONGVARBINARY NOT NULL,
    PRIMARY KEY(UIDPK),
    FOREIGN KEY (STORE_UID) REFERENCES TSTORE (UIDPK)
    ,
    FOREIGN KEY (CATALOG_UID) REFERENCES TCATALOG (UIDPK)
...
(
    ...
    FIELD_OLD_VALUE VARCHAR(4096),
    FIELD_NEW_VALUE VARCHAR(4096),
...
(
    UIDPK BIGINT NOT NULL,
    ITEM_KEY VARCHAR(4096) NOT NULL,
    ITEM_VALUE VARCHAR(4096),
...
(
    ...
    ROW_DATA VARCHAR(4096) NOT NULL,
    PRIMARY KEY(UIDPK),
