...
/**
 * Test the specific behaviour of the hash code / equals contract in {@link CategoryAttributeValueImpl}.
 */
@SuppressWarnings({ "PMD.TooManyStaticImports" })
public class CategoryAttributeValueImplHashCodeEqualsTest extends AbstractAttributeValueImplHashCodeEqualsTest {

	private CategoryAttributeValueImpl obj1;

	private CategoryAttributeValueImpl obj2;

	private CategoryAttributeValueImpl obj3;
	...
	@Before
	public void setUp() {
		obj1 = new CategoryAttributeValueImpl();
		obj2 = new CategoryAttributeValueImpl();
		obj3 = new CategoryAttributeValueImpl();
	}
