...
/**
 * Test the specific behaviour of the hash code / equals contract in {@link CategoryLoadTunerImpl}.
 */
@SuppressWarnings({ "PMD.TooManyStaticImports" })
public class CategoryLoadTunerImplHashCodeEqualsTest {

	private CategoryLoadTunerImpl obj1;

	private CategoryLoadTunerImpl obj2;

	private CategoryLoadTunerImpl obj3;
	...
	@Before
	public void setUp() {
		obj1 = new CategoryLoadTunerImpl();
		obj2 = new CategoryLoadTunerImpl();
		obj3 = new CategoryLoadTunerImpl();
	}
	...
	public void testReflexivityAllFieldsPopulated() {
		populateCategoryLoadTuner(obj1);
		assertReflexivity(obj1);
	}
	...
	public void testSymmetryAllFieldsPopulated() {
		populateCategoryLoadTuner(obj1);
		populateCategoryLoadTuner(obj2);
		assertSymmetry(obj1, obj2);
	}
	...
	public void testTransitivityAllFieldsPopulated() {
		populateCategoryLoadTuner(obj1);
		populateCategoryLoadTuner(obj2);
		populateCategoryLoadTuner(obj3);
		assertTransitivity(obj1, obj2, obj3);
	}
	...
	private void populateCategoryLoadTuner(final CategoryLoadTunerImpl loadTuner) {
		loadTuner.setLoadingChildren(false);
		loadTuner.setLoadingParent(false);
		loadTuner.setLoadingMaster(false);
		loadTuner.setLoadingCategoryType(false);
		loadTuner.setLoadingAttributeValue(false);
		loadTuner.setLoadingLocaleDependantFields(false);

		CategoryTypeLoadTuner categoryTypeLoadTuner = new CategoryTypeLoadTunerImpl();
		loadTuner.setCategoryTypeLoadTuner(categoryTypeLoadTuner);
	}
