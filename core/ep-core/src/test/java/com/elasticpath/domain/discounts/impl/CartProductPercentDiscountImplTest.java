...
/**
 * Test cases for <code>CartProductPercentDiscountImpl</code>.
 */
public class CartProductPercentDiscountImplTest {
	...
	private static final long ACTION_ID = 123L;
	...
	private CartProductPercentDiscountImpl createCartProductPercentDiscountImpl(final String ruleElementType,
		...
		CartProductPercentDiscountImpl discount = 
			new CartProductPercentDiscountImpl(ruleElementType, ruleId, actionId, productCode, percent, exceptions, maxItems) {
				private static final long serialVersionUID = 9159349867523495889L;
	...
	public void testCalculateOnEmptyCart() {
		...
		CartProductPercentDiscountImpl discount = 
			createCartProductPercentDiscountImpl("", RULE_ID, ACTION_ID, CART_ITEM_PRODUCT_CODE, "50", maxItems, EXCEPTION_STR);
	...
	public void testApplyOnSingleItem() {
		...
		final CartProductPercentDiscountImpl discount =	createCartProductPercentDiscountImpl("", RULE_ID, 
	...
	public void testApplyOnTwoItems() {
		...
		final CartProductPercentDiscountImpl discount = createCartProductPercentDiscountImpl("", RULE_ID, ACTION_ID, 
