...
public class CartSkuAmountDiscountActionImplTest extends AbstractTestRuleElementImpl {
	...
	protected RuleElement createTestRuleElement() {
		return new CartSkuAmountDiscountActionImpl();
	}
	...
	protected void checkGeneratedCode(final String code) {
		assertTrue(code.indexOf("new CartSkuAmountDiscountImpl") > 0);
