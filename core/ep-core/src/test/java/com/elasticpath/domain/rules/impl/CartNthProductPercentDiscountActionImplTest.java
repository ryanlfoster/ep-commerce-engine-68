...
public class CartNthProductPercentDiscountActionImplTest extends AbstractTestRuleElementImpl {

	private static final String DISCOUNT_PRODUCT = "10";
	...
	protected RuleElement createTestRuleElement() {
		return new CartNthProductPercentDiscountActionImpl();
	}
	...
	protected Set<RuleParameter> getValidParameterSet() {
		...
		ruleParameter.setValue(DISCOUNT_PRODUCT);
		parameterSet.add(ruleParameter);
	...
	protected void checkGeneratedCode(final String code) {
		assertTrue(code.indexOf("new CartNthProductPercentDiscountImpl") > 0);
