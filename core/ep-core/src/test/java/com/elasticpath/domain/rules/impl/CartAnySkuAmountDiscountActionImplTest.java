...
/**
 * Test cases for <code>CartAnySkuAmountDiscountActionImpl</code>.
 */
public class CartAnySkuAmountDiscountActionImplTest extends AbstractTestRuleElementImpl {
	...
	protected RuleElement createTestRuleElement() {
		return new CartAnySkuAmountDiscountActionImpl();
	}
	...
	protected void checkGeneratedCode(final String code) {
		assertTrue(code.indexOf("new CartAnySkuAmountDiscountImpl") > 0);
