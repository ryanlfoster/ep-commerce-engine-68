...
/** Test cases for <code>ProductConditionImpl</code>.*/
public class ProductConditionImplTest extends AbstractTestRuleElementImpl {

	private static final String PRODUCT_VALUE = "88";
	...
	protected RuleElement createTestRuleElement() {
		return new ProductConditionImpl();
	}
	...
	protected Set<RuleParameter> getValidParameterSet() {
		...
		RuleParameter ruleParameter = new RuleParameterImpl(RuleParameter.PRODUCT_CODE_KEY, PRODUCT_VALUE);
	...
	protected void checkGeneratedCode(final String code) {
		...
		assertTrue(code.indexOf(PRODUCT_VALUE) > 0);
	}
