...
/** Test cases for <code>CartSubtotalPercentDiscountActionImpl</code>.*/
public class CartSubtotalPercentDiscountActionImplTest extends AbstractTestRuleElementImpl {

	private static final String DISCOUNT_PERCENT = "10.00";
	...
	protected RuleElement createTestRuleElement() {
		return new CartSubtotalPercentDiscountActionImpl();
	}
	...
	protected void checkGeneratedCode(final String code) {
		assertTrue(code.indexOf("new CartSubtotalPercentDiscountImpl") > 0);
