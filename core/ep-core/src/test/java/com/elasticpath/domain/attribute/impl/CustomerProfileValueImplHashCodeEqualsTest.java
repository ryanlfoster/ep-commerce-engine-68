...
/**
 * Test the specific behaviour of the hash code / equals contract in {@link CustomerProfileValueImpl}.
 */
@SuppressWarnings({ "PMD.TooManyStaticImports" })
public class CustomerProfileValueImplHashCodeEqualsTest extends AbstractAttributeValueImplHashCodeEqualsTest {

	private CustomerProfileValueImpl obj1;

	private CustomerProfileValueImpl obj2;

	private CustomerProfileValueImpl obj3;
	...
	@Before
	public void setUp() {
		obj1 = new CustomerProfileValueImpl();
		obj2 = new CustomerProfileValueImpl();
		obj3 = new CustomerProfileValueImpl();
	}
