...
/** 
 * Test cases for <code>CartAnySkuPercentDiscountActionImpl</code>.
 */
public class CartAnySkuPercentDiscountActionImplTest extends AbstractTestRuleElementImpl {

	private static final String DISCOUNT_PERCENT = "15";
	...
	protected RuleElement createTestRuleElement() {
		return new CartAnySkuPercentDiscountActionImpl();
	}
	...
	protected void checkGeneratedCode(final String code) {
		assertTrue(code.indexOf("new CartAnySkuPercentDiscountImpl") > 0);
