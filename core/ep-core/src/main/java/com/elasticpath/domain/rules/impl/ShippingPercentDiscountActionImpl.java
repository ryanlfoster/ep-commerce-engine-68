 ...
 */
@Entity
@DiscriminatorValue("shippingPercentDiscountAction")
@DataCache(enabled = false)
public class ShippingPercentDiscountActionImpl extends AbstractRuleActionImpl implements RuleAction {
	/**
	 * Serial version id.
	 */
	...
	public String getRuleCode() throws EpDomainException {
		...
		code.append("\t\tdelegate.applyShippingDiscountPercent(cart, ");
