 ...
 */
@Entity
@DiscriminatorValue("productCondition")
@DataCache(enabled = false)
public class ProductConditionImpl extends AbstractRuleElementImpl implements RuleCondition {
	/**
	 * Serial version id.
	 */
	private static final long serialVersionUID = 5000000001L;
	
	private static final RuleElementType RULE_ELEMENT_TYPE = RuleElementType.PRODUCT_CONDITION;
	...
	public String getRuleCode() throws EpDomainException {
		...
		sbf.append(" delegate.catalogProductIs(product, "); // NOPMD - Broken up to allow readability
		sbf.append("true, \"");
