 ...
 */
@Entity
@Table(name = SkuAttributeValueImpl.TABLE_NAME)
public class SkuAttributeValueImpl extends AbstractAttributeValueImpl {

	/** The name of the table & generator to use for persistence. */
	public static final String TABLE_NAME = "TPRODUCTSKUATTRIBUTEVALUE";
	...
	public boolean equals(final Object obj) {
		if (!(obj instanceof SkuAttributeValueImpl)) {
			return false;
		}
