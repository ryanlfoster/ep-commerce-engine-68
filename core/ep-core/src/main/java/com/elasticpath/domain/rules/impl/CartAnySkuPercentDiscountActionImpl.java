 ...
 */
@Entity
@DiscriminatorValue("cartAnySkuPercentDiscountAction")
@DataCache(enabled = false)
public class CartAnySkuPercentDiscountActionImpl extends AbstractRuleActionImpl implements RuleAction {
	...
	private static final RuleElementType RULE_ELEMENT_TYPE = RuleElementType.CART_ANY_SKU_PERCENT_DISCOUNT_ACTION;
	...
	public String getRuleCode() throws EpDomainException {
		...
		sbf.append("\n\t insert(new CartAnySkuPercentDiscountImpl(\"").append(RULE_ELEMENT_TYPE).append("\", ");
