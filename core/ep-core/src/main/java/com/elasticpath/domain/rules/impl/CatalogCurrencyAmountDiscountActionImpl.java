...
public class CatalogCurrencyAmountDiscountActionImpl extends AbstractRuleActionImpl implements RuleAction {
	...
	public String getRuleCode() throws EpDomainException {
		...
		sbf.append("\t\tdelegate.applyCatalogCurrencyDiscountAmount(tracker, ");
