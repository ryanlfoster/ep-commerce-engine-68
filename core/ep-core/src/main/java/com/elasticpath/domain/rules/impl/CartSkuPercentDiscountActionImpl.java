 ...
 */
@Entity
@DiscriminatorValue("cartSkuPercentDiscountAction")
@DataCache(enabled = false)
public class CartSkuPercentDiscountActionImpl extends AbstractRuleActionImpl implements RuleAction {
	...
	private static final RuleElementType RULE_ELEMENT_TYPE = RuleElementType.CART_SKU_PERCENT_DISCOUNT_ACTION;
	...
	public String getRuleCode() throws EpDomainException {
		...
		sbf.append("\n\t insert(new CartSkuPercentDiscountImpl(\"").append(RULE_ELEMENT_TYPE).append("\", ");
