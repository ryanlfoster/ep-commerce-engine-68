 ...
 */
@Entity
@DiscriminatorValue("cartProductAmountDiscountAction")
@DataCache(enabled = false)
public class CartProductAmountDiscountActionImpl extends AbstractRuleActionImpl implements RuleAction {
	...
	private static final RuleElementType RULE_ELEMENT_TYPE = RuleElementType.CART_PRODUCT_AMOUNT_DISCOUNT_ACTION;
	...
	public String getRuleCode() throws EpDomainException {
		...
		sbf.append("\n\t insert(new CartProductAmountDiscountImpl(\"").append(RULE_ELEMENT_TYPE).append("\", ");
