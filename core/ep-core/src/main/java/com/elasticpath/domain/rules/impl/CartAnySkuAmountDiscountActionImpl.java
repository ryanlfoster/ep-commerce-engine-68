 ...
 */
@Entity
@DiscriminatorValue("cartAnySkuAmountDiscountAction")
@DataCache(enabled = false)
public class CartAnySkuAmountDiscountActionImpl extends AbstractRuleActionImpl implements RuleAction {
	...
	private static final RuleElementType RULE_ELEMENT_TYPE = RuleElementType.CART_ANY_SKU_AMOUNT_DISCOUNT_ACTION;
	...
	public String getRuleCode() throws EpDomainException {
		...
		sbf.append("\n\t insert(new CartAnySkuAmountDiscountImpl(\"").append(RULE_ELEMENT_TYPE).append("\", ");
