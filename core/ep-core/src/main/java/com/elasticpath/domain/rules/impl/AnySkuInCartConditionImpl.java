 ...
 */
@Entity
@DiscriminatorValue("anySkuInCartCondition")
@DataCache(enabled = false)
public class AnySkuInCartConditionImpl extends AbstractRuleElementImpl implements RuleCondition {
	/**
	 * Serial version id.
	 */
	private static final long serialVersionUID = 5000000001L;

	private static final RuleElementType RULE_ELEMENT_TYPE = RuleElementType.ANY_SKU_IN_CART_CONDITION;
	...
	public String getRuleCode() throws EpDomainException {
		...
		sbf.append(" delegate.cartContainsAnySku(cart, \"");
		sbf.append(getParamValue(RuleParameter.NUM_ITEMS_QUANTIFIER_KEY));
