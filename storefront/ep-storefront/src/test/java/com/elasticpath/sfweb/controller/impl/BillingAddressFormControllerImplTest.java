...
public class BillingAddressFormControllerImplTest {
	@Rule
	public final JUnitRuleMockery context = new JUnitRuleMockery();

	private BillingAddressFormControllerImpl controller;
	...
	public void setUp() throws Exception {
		...
		context.checking(new Expectations() { {
			...
			allowing(customer).getPreferredBillingAddress(); will(returnValue(billingAddress));
		} });

		controller = new BillingAddressFormControllerImpl();
	...
	public void testFormBackingObject() throws Exception {
		...
		assertSame("Sanity: controller should set billing address", billingAddress, command.getSelectedAddress());
	}
}
